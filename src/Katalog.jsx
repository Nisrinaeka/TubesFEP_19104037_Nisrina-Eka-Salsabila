...
export const Katalog = () => {
    ...
    return (
      ...
      <div className="container">
        ...
        {/* Search */}
        {/* dropdown */}
        <select onChange={handleChange} className='btn btn-warning dropdown-toggle w-100'  id="heroes" name="heroes">
        ...
        <div className="table-responsive">
          <table className="table table-hover">
            ...
            <tbody>
              ...
              <tr key={ index }>
                <td>{index + 1}</td>
                <td className='table-red'>{ pahlawan.name }</td>
      ...
      <div className="container-fluid py-2 border-top">
        <div className="container text-secondary">
          <small>
            Copyright by Nisrina Eka Salsabila
          </small>
        </div>
      </div>
    </div>
